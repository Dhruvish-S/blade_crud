...
<body>
    <div class="d-flex justify-content-center align-items-center  w-100" style="height:800px;">
        <div class="bg-light box" class="bg-secondary" style="width: 500px; height: 500px;  box-shadow: 5px 4px 2px 3px;">
        <h4 style="text-align: center;padding: 20px;color: blue; font-size: 30px;font-weight:800">Laravel Crud</h4>
            <p style="text-align: center;font-weight:800;font-size:22px;color:blue">Welcome to the User Registration</p>
